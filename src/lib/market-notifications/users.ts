...
export async function fetchPriceAlertUsers(
	...
	const { data, error } = await (supabase
		.from("users")
		.select(
			"id, email, phone_country_code, phone_number, market_asset_price_alerts_include_email, market_asset_price_alerts_include_sms, market_asset_price_alert_sensitivity",
		)
