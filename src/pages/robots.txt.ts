...
import { EXCLUDED_ROUTE_PREFIXES, ROBOTS_ONLY_DISALLOW_PREFIXES } from "../lib/seo/excluded-routes";
...
export const GET: APIRoute = () => {
	...
	const disallowLines = [...ROBOTS_ONLY_DISALLOW_PREFIXES, ...EXCLUDED_ROUTE_PREFIXES]
