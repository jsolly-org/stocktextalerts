<template>
	<figure class="tg-preview" aria-label="Telegram notification preview">
		<div class="phone-mockup">
			<div class="phone-frame-border">
				<div class="phone-screen">
					<div class="phone-status-bar" aria-hidden="true">
						<span class="status-time">{{ previewTimeLabel }}</span>
					...
					<div class="tg-body">
						...
						<div class="tg-bubble-received">
							...
							<span class="tg-time" aria-hidden="true">{{ previewTimeLabel }}</span>
						</div>
						...
						<div v-if="alert" class="tg-bubble-received tg-bubble-photo">
							...
							<div class="tg-caption">
								...
								<p class="tg-footer-text">{{ PREVIEW_FOOTER }}</p>
								<span class="tg-time" aria-hidden="true">{{ previewAlertTimeLabel }}</span>
							</div>
						</div>
					</div>
...
const PREVIEW_ALERT_MINUTE = 9 * 60 + 42;
...
const previewAlertTimeLabel = computed(() =>
	formatMinutesAsLocalTime(PREVIEW_ALERT_MINUTE, user.value.use_24_hour_time),
);
