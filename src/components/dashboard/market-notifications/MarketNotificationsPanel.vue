				...
				<div class="flex items-center justify-between gap-3">
					...
					<div class="min-w-0">
						...
						<p id="market_asset_price_alerts_enabled_description" class="text-sm text-body-secondary mt-0.5">
							Immediate alerts for significant price moves during US trading hours. Maximum two notifications per asset per day.
						</p>
					</div>
							...
							<div class="space-y-3">
								...
								<div class="grid [&>*]:col-start-1 [&>*]:row-start-1">
									...
									<div :class="activeRetuneStep === 3 ? 'visible' : 'invisible'" :inert="activeRetuneStep !== 3 || undefined">
										...
										<p class="text-xs text-body-secondary mb-2">Maximum two notifications per asset per day.</p>
										<div class="grid grid-cols-1 gap-2 sm:grid-cols-3">
											<label
