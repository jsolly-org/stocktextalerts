					...
					<div class="min-w-0">
						<div class="flex items-center gap-2">
							...
							<p
								...
								class="text-sm text-gray-600 mt-0.5"
							>
								Add a short news summary about the assets you're tracking. Email only.
							</p>
						</div>
					<span
					...
					<div class="min-w-0">
						<div class="flex items-center gap-2">
							...
							<p
								...
								class="text-sm text-gray-600 mt-0.5"
							>
								Add a short rumors/chatter summary about the assets you're tracking. Email only.
							</p>
						</div>
					<span
						:title="showEmailRequiredHint ? 'Enable the email channel to use this feature' : undefined"
					...
					<div class="flex items-center justify-between gap-3 py-3">
						...
						<div class="min-w-0">
							...
							<p
								...
								class="text-sm text-gray-600 mt-0.5"
							>
								See how analysts rate the stocks you're tracking (buy/hold/sell). <span class="text-gray-400 italic">ETFs are not included.</span>
							</p>
						</div>
