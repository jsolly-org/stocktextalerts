...
#
# INVARIANT: the basenames here must match the keys render-png.ts reads from the bundle root
# (src/lib/messaging/parts/charts/render-png.ts readChartAsset). A mismatch ships text-only
