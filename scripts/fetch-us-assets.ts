 ...
 *
 * Output format (scripts/us-assets.json):
 *   {
 ...
 *
 * Usage:
 *   npx tsx scripts/fetch-us-assets.ts
...
const OUTPUT_FILE = path.join(__dirname, "us-assets.json");

const FINNHUB_BASE_URL = "https://finnhub.io/api/v1";

// Finnhub `type` values we include, mapped to our normalized types.
// Stock-like securities: get all notification types (price, daily digest, weekly calendar).
