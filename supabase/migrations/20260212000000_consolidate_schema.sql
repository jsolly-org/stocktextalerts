...
DROP POLICY IF EXISTS "Anyone can view asset events" ON public.asset_events;
REVOKE SELECT ON TABLE public.asset_events FROM anon, authenticated;

/* ================================================================
   8.  IDENTITY — asset_events.id  ALWAYS → BY DEFAULT
   ================================================================ */

ALTER TABLE public.asset_events ALTER COLUMN id SET GENERATED BY DEFAULT;
